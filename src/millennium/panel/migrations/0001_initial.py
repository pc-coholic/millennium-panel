    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('standard_id', multiselectfield.db.fields.MultiSelectField(blank=True, choices=[('0', 'Not Set'), ('1', 'MOD10'), ('2', 'ANSI'), ('3', 'ABA'), ('4', 'CBA'), ('5', 'BOC'), ('6', 'ANSI59'), ('7', 'CCIT')], max_length=15, null=True, verbose_name='Card Verification Standard')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=32)),
                ('terminal_type', multiselectfield.db.fields.MultiSelectField(choices=[('00', 'Unknwon Terminal Type'), ('01', 'Card Type Terminal'), ('02', 'Universal Type Terminal'), ('03', 'Coin Terminal Type'), ('03', 'Maximim Terminal Type'), ('10', 'Smart Card Terminal Type')], default='02', max_length=17, verbose_name='Terminal Type')),
                ...
                ('incoming_call_mode', multiselectfield.db.fields.MultiSelectField(choices=[('0', 'Ringing disabled'), ('1', 'Ringing / Incoming Voice'), ('2', 'No Ringing / Data Call'), ('3', 'Ringing / Voice / Delayed Data Call')], default='1', max_length=7, verbose_name='Incoming Call mode')),
                ...
                ('language_scrolling_order', multiselectfield.db.fields.MultiSelectField(choices=[('1', 'English'), ('2', 'French'), ('3', 'Spanish'), ('4', 'Japanese')], default='1', help_text='MTR 2.x only', max_length=7, verbose_name='Language Scrolling Order - 1st language')),
                ...
                ('language_scrolling_order_2', multiselectfield.db.fields.MultiSelectField(choices=[('1', 'English'), ('2', 'French'), ('3', 'Spanish'), ('4', 'Japanese')], default='2', help_text='MTR 2.x only', max_length=7, verbose_name='Language Scrolling Order - 2nd language')),
                ...
                ('number_of_languages', multiselectfield.db.fields.MultiSelectField(choices=[('1', '1 Language'), ('2', '2 Languages'), ('3', '3 Languages (MTR 2.x only)'), ('4', '4 Languages (MTR 2.x only)')], default='2', help_text='MTR2.x only', max_length=7, verbose_name='Number of Languages')),
                ...
                ('default_language', multiselectfield.db.fields.MultiSelectField(choices=[('1', 'English'), ('2', 'French'), ('3', 'Spanish'), ('4', 'Japanese')], default='1', max_length=7, verbose_name='Default Language')),
