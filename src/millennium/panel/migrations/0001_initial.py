# -*- coding: utf-8 -*-
# Generated by Django 1.11.5 on 2018-03-20 16:24
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=32)),
                ('terminal_type', models.PositiveSmallIntegerField(choices=[('00', 'Unknown Terminal Type'), ('01', 'Card Type Terminal'), ('02', 'Universal Type Terminal'), ('03', 'Coin Terminal Type'), ('03', 'Maximim Terminal Type'), ('10', 'Smart Card Terminal Type')], default='02', verbose_name='Terminal Type')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('order', models.PositiveIntegerField()),
                ('rate_info', models.PositiveSmallIntegerField(blank=True, choices=[('0', 'NCC rated intralata'), ('1', 'LMS rate - local'), ('2', 'Fixed charge - local'), ('3', 'Rate not available'), ('4', 'Invalid NPA/NXX'), ('5', 'Toll intralata'), ('6', 'Toll interlata'), ('7', 'NCC rated interlata'), ('8', 'NCC rated local'), ('9', 'Toll international')], help_text='Toll international only available on MTR2.x', null=True, verbose_name='Rate Information')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=32)),
                ('effective_date', models.DateTimeField(verbose_name='Effictive Date')),
